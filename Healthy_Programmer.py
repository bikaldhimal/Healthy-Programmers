...
For example: first finished drinking water and then only eyes.
...
eyes ko exercise garnu vanxa tyas paschat harek 45 minutes ma physical exercise garnu vanxa ra harek 1 and half hour
...
print("Current Date and Time : ", getdate())

# Infinite loop
while True:
    # Office Hour : 09:00 Am to 17:00 Pm
    ...
    if now.__eq__("09:30:00"):
        ...
        while True:
            ...
            if user_input_.__eq__("EyDone"):
                f = "Eyes_Ex_log" + ".txt"
                with open(f, "a") as fl:
                    fl.write(f'{getdate()} - Eyes Exercise Done.')
                    print("Your exercise has been saved to log. Thank you !!!")
                break
            else:
    ...
    # 9:45 Am -> physical exercise
        ...
        while True:
            ...
            if user_input_.__eq__("ExDone"):
                f = "Physical_Ex_log" + ".txt"
                with open(f, "a") as fl:
                    fl.write(f'{getdate()} - Physical Exercise Done.')
                    print("Your exercise has been saved to log. Thank you !!!")
                break
            else:
    ...
    # 10:30 Am -> water, eyes, and physical exercise
        ...
        while True:
            ...
            user_input = input("Enter Drank if you are finished : ")
            user_input_ = user_input.lower()
            if user_input_.__eq__("Drank"):
                f = "Water_Ex_log" + ".txt"
                with open(f, "a") as fl:
                    fl.write(f'{getdate()} - Drank.')
                    print("Your activity has been saved to log. Thank you !!!")
                continue
            # eyes exercise
            os.system("afplay " + eyes_mp3)
            user_input = input("Enter EyDone if you are finished : ")
    ...
    # 11:30 Am -> eyes exercise
        ...
        while True:
            ...
            if user_input_.__eq__("EyDone"):
                ...
                print("Finish do the eyes exercise, Invalid Input !!!")
    # 12:00 Am -> water, eyes, and physical exercise
    ...
    # 16:00 pm -> eyes exercise
        ...
        while True:
            ...
            if user_input_.__eq__("EyDone"):
                ...
                print("Finish do the eyes exercise, Invalid Input !!!")
    # 16:30 pm -> water, eyes, and physical exercise
